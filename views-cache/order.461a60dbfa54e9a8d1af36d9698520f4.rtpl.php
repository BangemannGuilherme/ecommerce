...
<div class="content-wrapper">
    ...
    <h1>
    &nbsp;&nbsp;Order N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
    </h1>
    <ol class="breadcrumb">
        <li><a href="/admin"><i class="fa fa-dashboard"></i>&nbsp;&nbsp;Home&nbsp;&nbsp;</a></li>
        <li><a href="/admin/orders">&nbsp;&nbsp;Orders&nbsp;&nbsp;</a></li>
        <li class="active"><a href="/admin/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">&nbsp;&nbsp;Order N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>&nbsp;&nbsp;</a></li>
    </ol>
    </section>
    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/resources/site/images/logo.png" alt="Logo">
