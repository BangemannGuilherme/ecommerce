			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-6 text-center mb-5">
						<h2 class="heading-section"><!--<b>Guiboy</b>Ecommerce<b>--><br>Admin</b>Recovery Password</br></h2>
					</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-md-6 col-lg-4">
						<div class="login-wrap py-5">
							...
							<p class="text-center">Hello <?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?>, enter a new password below</p>
							...
							<form action="/admin/forgot/reset" method="post">
								...
								<div class="col-xs-8">	            				
	            					<div class="form-group">
										<button type="submit" class="btn form-control btn-primary rounded submit px-3">SAVE NEW PASSWORD</button>
	            					</div>
								</div>
